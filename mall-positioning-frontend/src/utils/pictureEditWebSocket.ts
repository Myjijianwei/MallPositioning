export default class PictureEditWebSocket {
  ...
  constructor(guardianId: number, monitorId: number) {
    this.guardianId = guardianId // 监护人 ID
    this.monitorId = monitorId // 监控端 ID
   ...
   */
  connect() {
    const DEV_BASE_URL = "ws://localhost:8001";
    // 线上地址
    // const PROD_BASE_URL = "ws://81.69.229.63";
    const url = `ws://your-server/gps-websocket?guardianId=${guardianId}&monitorId=${monitorId}`
